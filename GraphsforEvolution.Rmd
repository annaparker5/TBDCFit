...
```{r}
ggplot(data = scandata[scandata$fate == "wander", ], aes(x = area)) + 
...
```{r}
ggplot(data = scandata[scandata$fate == "em", ], aes(x = area)) + 
...
```{r}
ggplot(data = scandata[scandata$fate == "wowe mongo", ], aes(x = area)) + 
