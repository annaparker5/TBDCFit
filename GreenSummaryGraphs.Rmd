...
```{r}
GRCfitnessplot <- ggplot(aes(x = tot.area, y = rel.fitness.med), data = gfitness) + 
  theme_bw() +
  xlim(0, 8000) + 
  ylim(0, 4.5) + 
  geom_smooth(aes(linetype = type), method = "lm", alpha = 0.2, color = "dark gray") +
...
```{r}
ggsave("~/Desktop/GitHub/TBDCFit/Figures/GRCGreenmedian.png", GRCfitnessplot, width = 6, height = 5)
```
