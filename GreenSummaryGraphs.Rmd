...
```{r}
greenconsumpplot <- ggplot(aes(x = treatment, y = tot.area, color = treatment, shape = type, fill = treatment), 
                           data = garea) + 
  theme_bw() + 
...
```{r}
greenflowerplot <- ggplot(aes(x = treatment, y = tot.flowers, color = treatment, shape = type, fill = treatment), 
                           data = gflowers) + 
  theme_bw() + 
  geom_violin(alpha = 0.5, scale = "width") + 
  geom_point(alpha = 0.8, position = position_jitter(width = .2, height = 0)) + 
...
```{r}
greenpodsplot <- ggplot(aes(x = treatment, y = num.pods.m, color = treatment, shape = type, fill = treatment), 
                           data = gpods) + 
  theme_bw() + 
  geom_violin(alpha = 0.5, scale = "width") + 
  geom_point(alpha = 0.8, position = position_jitter(width = .2, height = 0)) + 
...
```{r}
greenseedplot <- ggplot(aes(x = treatment, y = success, color = treatment, shape = type, fill = treatment), 
                           data = gseedout) + 
  theme_bw() + 
  geom_violin(alpha = 0.5, scale = "width") + 
  geom_point(alpha = 0.8, position = position_jitter(width = .2, height = 0)) + 
