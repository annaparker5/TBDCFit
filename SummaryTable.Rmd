...
Exclude those without pods: 

```{r}
fTBseed <- fTBseed[fTBseed$pid != 23, ]
fTBseed <- fTBseed[fTBseed$pid != 141, ]


fDCseed <- fDCseed[fDCseed$pid != 78, ]
fDCseed <- fDCseed[fDCseed$pid != 140, ]
```


```{r}
fTBseed <- fTBseed[fTBseed$mature != "no", ]
```
