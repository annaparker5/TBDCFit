...
```{r}
write.csv(x = outputfield, file = "~/Desktop/GitHub/TBDCFit/Data/FieldLeafArea.csv")
write.csv(x = outputgreen, file = "~/Desktop/GitHub/TBDCFit/Data/Greenhouse/GreenLeafArea.csv")
```
