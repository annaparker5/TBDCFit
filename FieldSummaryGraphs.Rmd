...
```{r}
GRCfitnessplotB <- ggplot(aes(x = tot.area, y = rel.fitness.med), data = ffitnesssubset) + 
  theme_bw() +
  xlim(0, 7000) + 
  ylim(0, 33) + 
  geom_smooth(aes(linetype = type), method = "lm", alpha = 0.2, color = "dark gray") +
...
save graph: 
```{r}
ggsave("~/Desktop/GitHub/TBDCFit/Figures/GRCFieldmedian.png", GRCfitnessplotB, width = 6, height = 5)
```
