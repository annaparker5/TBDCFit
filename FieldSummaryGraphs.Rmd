...
```{r}
fmodfitnesssubset <- lmer(success ~ treatment*type + (1|column), data = ffitnesssubset, REML = FALSE)
...
```{r}
fmodfitnesssubset2 <- lmer(success ~ tot.area*type + (1|column), data = ffitnesssubset, REML = FALSE)
